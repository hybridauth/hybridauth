 ...
 */
class Hybridauth_Provider_Facebook extends Hybridauth_Core_Provider_Model
{
	...
	*/
	function initialize() 
	{
		...
		$this->api = new Hybridauth_Provider_Facebook_SDK( ARRAY( 'appId' => $this->config["keys"]["id"], 'secret' => $this->config["keys"]["secret"] ) ); 
	...
	*/
	function loginBegin()
	{
		...
		Hybridauth_Core_Common_HTTP::redirect( $url );
	}
