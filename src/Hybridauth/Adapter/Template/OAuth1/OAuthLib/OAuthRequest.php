...
class OAuthRequest {
	...
	public function to_url() {
		$post_data = $this->postdata_httprequest ();
	...
	/**
	 * builds the parameters into a string
	 */
	public function postdata_httprequest() {
		return OAuthUtil::build_http_query ( $this->get_postdata() );
	}
