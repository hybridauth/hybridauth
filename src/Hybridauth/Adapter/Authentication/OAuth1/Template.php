...
class Template implements \Hybridauth\Adapter\AuthenticationInterface
{
	...
	*/
	...
	{
		$defaults = array( "oauth_token" => $this->tokens->requestToken );
	...
	public function storeTokens( \Hybridauth\Adapter\Authentication\OAuth1\TokensInterface $tokens )
	{
	...
	{ 
		$defaults = array( 'oauth_callback' => $this->endpoints->redirectUri );
	...
	public function requestAccessToken( $parameters = array(), $method = 'GET' )
	{
		$defaults = array();
	...
	private function _signedRequest( $uri, $method = 'GET', $parameters = array(), $authHeader = true /* <= fixme! */ )
	{
