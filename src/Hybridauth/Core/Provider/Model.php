 ...
 */
abstract class Hybridauth_Core_Provider_Model
{
	...
	*/
	function __construct( $providerId, $config, $params = NULL, Hybridauth_Core_Storage_Interface $storage = null, Hybridauth_Core_Common_LoggerInterface $logger = null )
	{
		...
		if( ! $params ){
			$this->params = $this->storage->get( "hauth_session.$providerId.id_provider_params" );
		}
		else{
			$this->params = $params;
		}
		...
		// new user instance
		$this->user = new Hybridauth_Core_User();
